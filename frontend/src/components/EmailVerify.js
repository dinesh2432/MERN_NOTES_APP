...
const EmailVerify = () => {
    ...
    const handleEmailVerify = async(email) =>{
        ...
        try{
            const res = await axios.post(`https://mern-notes-app-86t8.vercel.app/api/auth/email-verify`,{email},{withCredentials:true,headers: { "Content-Type": "application/json" }})
            setIsToggle(true)
